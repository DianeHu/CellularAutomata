...
/**
 * @author Tyler Yam
 * This is a subclass of the XMLReader for the Foraging Ants simulation
 * This class allows a data file for the Foraging Ants simulation to be read as a specific XML format
 */
public class ForagingAntsReader extends XMLReader {
	 ...
	 * @param dataFile
	 * @return
	 * This method returns a ForagingAntsConfiguration with data values taken from the data file input
	 */
