...
/**
 * @author Tyler Yam
 * This is a subclass of the GridConfiguration superclass for the Foraging Ants simulation
 * This class sets up how the XML file should be formatted for the Foraging Ants simulation
...
public class ForagingAntsConfiguration extends GridConfiguration {
	...
	/**
	 * @return
	 * Returns the maxAnts for Foraging Ant simulation
	 */
	...
	/**
	 * @return
	 * Returns X location for home for Foraging Ant simulation
	 */
	...
	/**
	 * @return
	 * Returns Y location for home for Foraging Ant simulation
	 */
	...
	/**
	 * @return
	 * Returns X location for food for Foraging Ant simulation
	 */
	...
	/**
	 * @return
	 * Returns Y location for food for Foraging Ant simulation
	 */
